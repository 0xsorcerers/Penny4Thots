...
export interface Translations {
  ...
  market: {
    ...
    kamikazePositionsUpdated: string;
    tryAgain: string;
  };
  // Vote Modal
  voteModal: {
  ...
  createMarket: {
    ...
    marketCreatedSuccess: string;
    marketCreatedFailed: string;
  };
  // Market Card
  marketCard: {
    tags: string;
...
export const translations: Record<LanguageCode, Translations> = {
  EN: {
    ...
    market: {
      ...
      kamikazePositionsUpdated: "Kamikazed {count} positions.",
    ...
    voteModal: {
      ...
      balanceRequired: "You have {balance} but need {required}",
    ...
    createMarket: {
      ...
      marketCreatedFailed: "Failed to create market",
    },
    // Common
    marketCard: {
      tags: "tags",
    ...
    marketGrid: {
      ...
      loadFailed: "Failed to load markets from blockchain",
  ...
  ES: {
    ...
    market: {
      ...
      kamikazePositionsUpdated: "Kamikaze ejecutado en {count} posiciones.",
    ...
    voteModal: {
      ...
      balanceRequired: "Tienes {balance} pero necesitas {required}",
    ...
    createMarket: {
      ...
      marketCreatedSuccess: "¡Mercado creado con éxito!",
      marketCreatedFailed: "Error al crear mercado",
    },
    marketCard: {
      tags: "tags",
      moreTags: "+{count} tags",
    ...
    marketGrid: {
      ...
      loadingMarkets: "Cargando mercados...",
      loadFailed: "Error al cargar mercados desde blockchain",
  ...
  FR: {
    ...
    market: {
      ...
      kamikazePositionsUpdated: "{count} positions kamikazées.",
    ...
    voteModal: {
      ...
      balanceRequired: "Vous avez {balance} mais il faut {required}",
    ...
    createMarket: {
      ...
      marketCreatedFailed: "Échec de création du marché",
    },
    marketCard: {
      tags: "tags",
      moreTags: "+{count} tags",
    ...
    marketGrid: {
      ...
      loadFailed: "Échec du chargement des marchés depuis la blockchain",
  ...
  DE: {
    ...
    market: {
      ...
      kamikazePositionsUpdated: "{count} Positionen kamikaziert.",
    ...
    voteModal: {
      ...
      balanceRequired: "Du hast {balance}, brauchst aber {required}",
    ...
    createMarket: {
      ...
      marketCreatedFailed: "Markterstellung fehlgeschlagen",
    },
    marketCard: {
      tags: "tags",
      moreTags: "+{count} tags",
    ...
    marketGrid: {
      ...
      loadFailed: "Fehler beim Laden der Märkte aus der Blockchain",
  ...
  PT: {
    ...
    market: {
      ...
      kamikazePositionsUpdated: "{count} posições executadas em kamikaze.",
    ...
    voteModal: {
      ...
      balanceRequired: "Você tem {balance}, mas precisa de {required}",
    ...
    createMarket: {
      ...
      invalidImageUrl: "URL inválida",
      marketCreatedSuccess: "Mercado criado com sucesso!",
      marketCreatedFailed: "Falha ao criar mercado",
    },
    marketCard: {
      tags: "tags",
      moreTags: "+{count} tags",
    ...
    marketGrid: {
      ...
      loadFailed: "Falha ao carregar mercados da blockchain",
  ...
  ZH: {
    ...
    market: {
      ...
      kamikazePositionsUpdated: "已对 {count} 个仓位执行 kamikaze。",
      tryAgain: "请重试",
    },
    voteModal: {
      selectOption: "选择选项",
      ...
      approvalDesc: "正在授权代币",
      tokenApproved: "授权成功！",
      balanceRequired: "你有 {balance}，但需要 {required}",
      proceedAnyway: "仍可继续",
