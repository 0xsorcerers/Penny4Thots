...
export const translations: Record<LanguageCode, Translations> = {
  EN: {
    ...
    kamikazeModal: {
      positions: "Positions",
      toggleDescription: "Toggle the positions you want to kamikaze in this market.",
      first: "First",
      second: "Second",
      third: "Third",
      fourth: "Fourth",
  ...
  ES: {
    ...
    kamikazeModal: {
      ...
      toggleDescription: "Activa las posiciones que quieres kamikaze en este mercado.",
      first: "Primera",
      second: "Segunda",
      third: "Tercera",
      fourth: "Cuarta",
      ...
      noPositionsFound: "No se encontraron posiciones para este mercado.",
    },
    createMarket: {
    ...
    marketPage: {
      ...
      trade: "Trade",
      tradeHaircutNotice:
        "Las operaciones Kamikaze tienen un recorte del 50% para quienes deseen alternar una posición de voto",
  ...
  FR: {
    ...
    kamikazeModal: {
      positions: "Positions",
      toggleDescription: "Activez les positions que vous voulez kamikaze dans ce marché.",
      first: "Première",
      second: "Deuxième",
      third: "Troisième",
      fourth: "Quatrième",
      ...
      noPositionsFound: "Aucune position trouvée pour ce marché.",
    },
    createMarket: {
      detailsStep: "Détails",
    ...
    marketPage: {
      ...
      trade: "Trade",
      tradeHaircutNotice:
        "Les transactions Kamikaze subissent une décote de 50% pour ceux qui souhaitent alterner une position de vote",
      createdOn: "Créé {date}",
      voteSingular: "vote",
      votePlural: "votes",
      live: "En direct",
  ...
  DE: {
    ...
    kamikazeModal: {
      ...
      toggleDescription: "Aktiviere die Positionen, die du in diesem Markt kamikaze möchtest.",
      first: "Erste",
      second: "Zweite",
      third: "Dritte",
      fourth: "Vierte",
      ...
      noPositionsFound: "Keine Positionen für diesen Markt gefunden.",
    },
    createMarket: {
      detailsStep: "Details",
    ...
    marketPage: {
      ...
      trade: "Trade",
      tradeHaircutNotice:
        "Kamikaze trades haben einen Abschlag von 50% für alle, die eine Stimmposition wechseln möchten",
  ...
  PT: {
    ...
    kamikazeModal: {
      positions: "Posições",
      toggleDescription: "Ative as posições que deseja kamikaze neste mercado.",
      first: "Primeira",
      second: "Segunda",
      third: "Terceira",
      fourth: "Quarta",
      ...
      noPositionsFound: "Nenhuma posição encontrada para este mercado.",
    },
    createMarket: {
    ...
    marketPage: {
      ...
      trade: "Trade",
      tradeHaircutNotice:
        "As negociações Kamikaze têm um corte de 50% para quem desejar alternar uma posição de voto",
  ...
  ZH: {
    ...
    kamikazeModal: {
      positions: "持仓",
      toggleDescription: "选择要在此市场执行 Kamikaze 的持仓。",
      first: "第一",
      second: "第二",
      third: "第三",
      fourth: "第四",
  ...
  JA: {
    ...
    kamikazeModal: {
      positions: "ポジション",
      toggleDescription: "このマーケットでカミカazeしたいポジションを選択してください。",
      first: "第一",
      second: "第二",
      third: "第三",
      fourth: "第四",
      ...
      selected: "選択",
      processing: "処理中...",
      noPositionsFound: "このマーケットのポジションが見つかりません。",
    },
    createMarket: {
      detailsStep: "詳細",
      confirmStep: "確認",
    ...
    marketPage: {
      ...
      castVote: "投票する",
      trade: "取引",
      tradeHaircutNotice: "Kamikaze 投票ポジションを切り替える場合、取引には50%のヘアカットが適用されます",
      createdOn: "作成日 {date}",
      voteSingular: "票",
      votePlural: "票",
      live: "進行中",
  ...
  KO: {
    ...
    kamikazeModal: {
      positions: "포지션",
      toggleDescription: "이 마켓에서 kamikaze할 포지션을 선택하세요.",
      first: "첫",
      second: "두",
      third: "세",
      fourth: "네",
      ...
      selected: "선택",
      processing: "처리 중...",
      noPositionsFound: "이 마켓의 포지션을 찾을 수 없습니다.",
    },
    createMarket: {
      detailsStep: "세부사항",
      confirmStep: "확인",
    ...
    marketPage: {
      ...
      castVote: "투표하기",
      trade: "거래",
      tradeHaircutNotice: "Kamikaze 투표 포지션을 전환하려는 경우 거래에 50% 헤어컷이 적용됩니다",
      createdOn: "생성일 {date}",
      voteSingular: "표",
      votePlural: "표",
      live: "진행 중",
  ...
  HI: {
    ...
    kamikazeModal: {
      positions: "पोजीशन",
      toggleDescription: "इस बाजार में kamikaze करने के लिए पोजीशन टॉगल करें।",
      first: "पहली",
      second: "दूसरी",
      third: "तीसरी",
      fourth: "चौथी",
    ...
    marketPage: {
      ...
      castVote: "वोट दें",
      trade: "व्यापार",
      tradeHaircutNotice: "Kamikaze वोट पोजीशन स्विच करने के लिए ट्रेड पर 50% हेयरकट लागू होता है",
  ...
  AR: {
    ...
    kamikazeModal: {
      positions: "المراكز",
      toggleDescription: "بدّل المراكز التي تريد تنفيذ Kamikaze في هذا السوق.",
      first: "الأول",
      second: "الثاني",
      third: "الثالث",
      fourth: "الرابع",
    ...
    marketPage: {
      ...
      castVote: "صوت",
      trade: "تداول",
      tradeHaircutNotice: "تنطبق خصم 50% على التداولات لمن يريد تبديل مركز التصويت Kamikaze",
  ...
  HE: {
    ...
    kamikazeModal: {
      positions: "עמדות",
      toggleDescription: "הפעל את העמדות שברצונך לבצע בהן Kamikaze בשוק זה.",
      first: "ראשונה",
      second: "שנייה",
      third: "שלישית",
      fourth: "רביעית",
    ...
    marketPage: {
      ...
      castVote: "הצבע",
      trade: "מסחר",
      tradeHaircutNotice: "למסחרי Kamikaze יש תספורת של 50% לכל מי שמעוניין להחליף עמדה בהצבעה",
