...
import lightblueFlora from "../assets/images/lightblue-flora.webp";
import lightFlora from "../assets/images/light-flora.webp";
import seagreenFlora from "../assets/images/seagreen-flora.webp";
  ...
  [HASHKEY_CHAIN_ID]: {
    light: {
      tokens: {
        ...
        foreground: "#19112F",
        card: "#DAC9FF",
        "card-foreground": "#19112F",
        primary: "#C8ADFF",
        "primary-foreground": "#140C29",
        secondary: "#D8C4FF",
        "secondary-foreground": "#20143B",
        muted: "#E1D2FF",
        "muted-foreground": "#514079",
        accent: "#6F43D6",
        ...
        yes: "#7D51E8",
        no: "#B04C8D",
        "sidebar-background": "#DECEFF",
        "sidebar-primary": "#6F43D6",
        "sidebar-primary-foreground": "#F6F1FF",
        "sidebar-accent": "#D7C5FA",
        "sidebar-ring": "#8A5BEB",
        chalk: "#19112F",
        "status-urgent": "#8A5BEB",
        "status-normal": "#6F43D6",
        "status-inactive": "#6C5A94",
        "modal-silver": "#9A88C2",
        "modal-sky-blue": "#8A5BEB",
        "modal-bright-blue": "#6F43D6",
        "modal-bg": "270 40% 10%",
        "surface-base": "#DAC9FF",
        "surface-border": "#BFA8EA",
        "surface-hover": "#D7C5FA",
        "surface-shadow": "#19112F",
        "surface-highlight": "#EBDDFF",
      },
    },
    dark: {
      tokens: {
        ...
        foreground: "#F0E9FF",
        card: "#131021",
        "card-foreground": "#F0E9FF",
        primary: "#A678FF",
        "primary-foreground": "#120B25",
        secondary: "#1A1630",
        "secondary-foreground": "#DED2FF",
        muted: "#16122A",
        "muted-foreground": "#9C8BC8",
        accent: "#C3A1FF",
        "accent-foreground": "#1A1135",
        border: "#292246",
        input: "#1D1735",
        ring: "#A678FF",
        yes: "#A678FF",
        no: "#DF72B0",
        "sidebar-background": "#110D22",
        "sidebar-primary": "#A678FF",
        "sidebar-primary-foreground": "#120B25",
        "sidebar-accent": "#1D1735",
        "sidebar-ring": "#A678FF",
        chalk: "#F0E9FF",
        "status-urgent": "#C3A1FF",
        "status-normal": "#A678FF",
        "status-inactive": "#9C8BC8",
        "modal-silver": "#8579A3",
        "modal-sky-blue": "#A678FF",
        "modal-bright-blue": "#8A5BEB",
        "modal-bg": "270 40% 8%",
        "surface-base": "#131021",
        "surface-border": "#292246",
        "surface-hover": "#1A1630",
        "surface-shadow": "#04030A",
        "surface-highlight": "#33295C",
      },
    },
  },
  [MANTA_CHAIN_ID]: {
  ...
  [ROBINHOOD_CHAIN_ID]: {
    light: {
      tokens: {
        ...
        foreground: "#0A2A1A",
        card: "#E8F5EC",
        "card-foreground": "#0A2A1A",
        primary: "#00C805",
        "primary-foreground": "#FFFFFF",
        secondary: "#D4F0D8",
        "secondary-foreground": "#0A2A1A",
        muted: "#E0F2E4",
        "muted-foreground": "#3A5A4A",
        accent: "#00E008",
        "accent-foreground": "#FFFFFF",
        border: "#B8E0BC",
        input: "#D0EBD4",
        ...
        yes: "#00C805",
        no: "#E85A5A",
        "sidebar-background": "#F5FAF7",
        "sidebar-primary": "#00C805",
        "sidebar-primary-foreground": "#FFFFFF",
        "sidebar-accent": "#E0F2E4",
        "sidebar-ring": "#00C805",
        chalk: "#0A2A1A",
        "status-urgent": "#00C805",
        "status-normal": "#00E008",
        "status-inactive": "#5A8A7A",
        "modal-silver": "#8AAFB8",
        "modal-sky-blue": "#00C805",
        "modal-bright-blue": "#00E008",
        "modal-bg": "120 62% 4%",
        "surface-base": "#E8F5EC",
        "surface-border": "#B8E0BC",
        "surface-hover": "#D0EBD4",
        "surface-shadow": "#0A2A1A",
        "surface-highlight": "#F0FCF4",
      },
    },
    dark: {
      tokens: {
        ...
        foreground: "#E0F7E8",
        card: "#12251A",
        "card-foreground": "#E0F7E8",
        primary: "#00C805",
        "primary-foreground": "#FFFFFF",
        secondary: "#1A2E20",
        "secondary-foreground": "#C0ECC8",
        muted: "#152518",
        "muted-foreground": "#8AB490",
        accent: "#00E008",
        "accent-foreground": "#0A1A10",
        border: "#203528",
        input: "#1C3024",
        ring: "#00C805",
        yes: "#00C805",
        no: "#FF6B6B",
        "sidebar-background": "#111E14",
        "sidebar-primary": "#00C805",
        "sidebar-primary-foreground": "#FFFFFF",
        "sidebar-accent": "#203528",
        "sidebar-ring": "#00C805",
        chalk: "#E0F7E8",
        "status-urgent": "#00E008",
        "status-normal": "#00C805",
        "status-inactive": "#6A9A78",
        "modal-silver": "#6A8A78",
        "modal-sky-blue": "#00C805",
        "modal-bright-blue": "#00E008",
        "modal-bg": "120 62% 4%",
        "surface-base": "#12251A",
        "surface-border": "#203528",
        "surface-hover": "#1A2E20",
        "surface-shadow": "#050F08",
        "surface-highlight": "#2A4030",
      },
    },
  },
};
