...
import { Brain, ArrowLeft, Loader2, Sparkles, ChevronLeft, ChevronRight, RefreshCw } from "lucide-react";
          ...
          >
            ...
            {account?.address && (
              <button
                ...
                className="flex items-center gap-2 rounded-full bg-emerald-500/10 px-4 py-2 font-outfit text-sm text-emerald-500 hover:bg-emerald-500/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
