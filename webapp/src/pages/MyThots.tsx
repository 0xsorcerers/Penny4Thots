...
export default function MyThots() {
  ...
  const fetchUserThots = useCallback(async () => {
    if (!account?.address) {
      setIsLoading(false);
      return;
    }
    ...
    try {
      ...
      // Get the count of user's thots
      const count = await getUserThotsCount(userAddress);
      ...
      const marketIds = await getUserThots(userAddress, 0, count);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 pt-24 pb-12 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-secondary shadow-lg shadow-primary/25">
        ...
        <AnimatePresence mode="wait">
          {!account?.address ? (
            ...
            >
              ...
              <p className="font-outfit text-muted-foreground">Loading your thots...</p>
            </motion.div>
          ) : markets.length > 0 ? (
            <motion.div
              key="grid"
