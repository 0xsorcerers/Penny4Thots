...
export function Header({ onConnect, isConnected = false }: HeaderProps) {
  ...
  return (
    <motion.header
      ...
      className="fixed left-0 right-0 top-0 z-50 border-b bg-white/70 backdrop-blur-xl border-white/50 shadow-[0_2px_16px_-4px_hsl(220_30%_15%/0.08)] dark:bg-background/80 dark:border-border/40 dark:shadow-none"
    >
